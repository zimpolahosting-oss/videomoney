...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'signInBody': 'Sign in to keep counting ads and managing payouts.',
      'signUpBody':
      ...
      'wallet': 'Wallet',
      'profile': 'Profile',
      'rewardConfirmedViewsAdded': 'Reward confirmed. Ad counted.',
      'rewardConfirmedViewsAddedCount': '+{count} ads counted.',
      'bonusViewsAdded': '🎁 +{count} ads counted',
      ...
      'watchVideosEarnPaid': 'Watch ads, count ads, and get paid.',
      'currentViews': 'Current ads',
      'videosWatched': 'Videos Watched',
      'progressToPayout': 'Progress to payout',
      'youAreOnYourWay': 'You\'re on your way.',
      'earnViewsNow': 'Earn ads now.',
      'payoutUnlocked': 'Payout unlocked. You can request payout in the Wallet.',
      'moreViewsUntilPayout': '{views} more ads until payout.',
      'dailyBonus': 'Daily Bonus',
      'watchDailyVideosBonus': 'Complete {videos} ads daily to count more ads.',
      'bonusClaimed': 'Bonus claimed',
      'bonus': 'Bonus',
      'earnViewsTitle': 'Earn ads',
      'watchRewardedEarnViews': 'Watch rewarded ads and count ads instantly.',
      'earnViews': 'Earn ads',
      'howItWorks': 'How it works',
      'watch': 'Watch',
      'watchShortVideo': 'Watch a short video',
      'earnStep': 'Earn',
      'getViewsReward': 'Get ads counted as reward',
      'cashOut': 'Cash Out',
      'reachViews': 'Reach {views} ads',
      'dailyChallenge': 'Daily Challenge',
      'watchTodayVideosBonus': 'Complete {videos} ads today and count more ads!',
      ...
      'leaderboardSubtitle': 'Top ads and estimated earnings from players.',
      ...
      'termsViewsTitle': 'Ads and rewards',
      ...
      'termsUsingBullet2': 'One person may not abuse multiple accounts, bots, scripts, VPN rotation, or emulator farms to generate extra ads.',
      'termsUsingBullet3':
          'Rewarded ads, Firebase authentication, and payout review remain protected by the existing platform setup.',
      'termsViewsBullet1': 'The ads counted in the app are promotional reward units used inside VideoMoney.',
      'termsViewsBullet2':
    ...
    'nl': {
      ...
      'signInBody': 'Log in om ads te blijven tellen en uitbetalingen te beheren.',
      'signUpBody':
      ...
      'wallet': 'Wallet',
      'profile': 'Profiel',
      'rewardConfirmedViewsAdded': 'Beloning bevestigd. Ad geteld.',
      'rewardConfirmedViewsAddedCount': '+{count} ads geteld.',
      'bonusViewsAdded': '🎁 +{count} ads geteld',
      ...
      'watchVideosEarnPaid': 'Bekijk advertenties, tel ads en word uitbetaald.',
      'currentViews': 'Huidige ads',
      'videosWatched': 'Video\'s bekeken',
      'progressToPayout': 'Voortgang naar uitbetaling',
      'youAreOnYourWay': 'Je bent goed op weg.',
      'earnViewsNow': 'Verdien nu ads.',
      'payoutUnlocked':
          'Uitbetaling vrijgespeeld. Je kunt nu een uitbetaling aanvragen in Wallet.',
      'moreViewsUntilPayout': 'Nog {views} ads tot uitbetaling.',
      'dailyBonus': 'Dagelijkse bonus',
      'watchDailyVideosBonus': 'Voltooi dagelijks {videos} ads om meer ads te tellen.',
      'bonusClaimed': 'Bonus geclaimd',
      'bonus': 'Bonus',
      'earnViewsTitle': 'Verdien ads',
      'watchRewardedEarnViews': 'Bekijk rewarded advertenties en tel direct ads.',
      'earnViews': 'Verdien ads',
      'howItWorks': 'Hoe het werkt',
      'watch': 'Kijk',
      'watchShortVideo': 'Bekijk een korte video',
      'earnStep': 'Verdien',
      'getViewsReward': 'Ontvang getelde ads als beloning',
      'cashOut': 'Uitcashen',
      'reachViews': 'Bereik {views} ads',
      'dailyChallenge': 'Dagelijkse challenge',
      'watchTodayVideosBonus': 'Voltooi vandaag {videos} ads en tel meer ads!',
      ...
      'leaderboardTitle': 'Leaderboard',
      'leaderboardSubtitle': 'Top ads en geschatte opbrengsten van spelers.',
      ...
      'termsViewsTitle': 'Ads en beloningen',
      ...
      'termsUsingBullet2': 'Eén persoon mag geen misbruik maken van meerdere accounts, bots, scripts, VPN-rotatie of emulatorfarms om extra ads te genereren.',
      'termsUsingBullet3':
          'Rewarded advertenties, Firebase-authenticatie en uitbetalingscontrole blijven beschermd door de bestaande platformopzet.',
      'termsViewsBullet1': 'De ads die in de app worden geteld zijn promotionele beloningsunits binnen VideoMoney.',
      'termsViewsBullet2':
    ...
    'hi': {
      ...
      'signInBody': 'Ads गिनते रहने और भुगतान प्रबंधित करने के लिए साइन इन करें।',
      'signUpBody':
      ...
      'wallet': 'वॉलेट',
      'profile': 'प्रोफ़ाइल',
      'rewardConfirmedViewsAdded': 'रिवॉर्ड पुष्टि हुई। Ad गिना गया।',
      'rewardConfirmedViewsAddedCount': '+{count} ads गिने गए।',
      'bonusViewsAdded': '🎁 +{count} ads गिने गए',
      ...
      'watchVideosEarnPaid': 'Ads देखें, ads गिनें और भुगतान पाएँ।',
      'currentViews': 'मौजूदा ads',
      'videosWatched': 'देखे गए वीडियो',
      'progressToPayout': 'भुगतान तक प्रगति',
      'youAreOnYourWay': 'आप सही रास्ते पर हैं।',
      'earnViewsNow': 'अभी ads कमाएँ।',
      'payoutUnlocked':
          'भुगतान अनलॉक हो गया है। अब आप वॉलेट में भुगतान अनुरोध कर सकते हैं।',
      'moreViewsUntilPayout': 'भुगतान तक {views} ads बाकी हैं।',
      'dailyBonus': 'दैनिक बोनस',
      'watchDailyVideosBonus': 'रोज़ {videos} ads पूरे करें और अधिक ads गिनें।',
      'bonusClaimed': 'बोनस लिया गया',
      'bonus': 'बोनस',
      'earnViewsTitle': 'Ads कमाएँ',
      'watchRewardedEarnViews': 'Rewarded ads देखें और तुरंत ads गिनें।',
      'earnViews': 'Ads कमाएँ',
      'howItWorks': 'यह कैसे काम करता है',
      'watch': 'देखें',
      'watchShortVideo': 'एक छोटा वीडियो देखें',
      'earnStep': 'कमाएं',
      'getViewsReward': 'इनाम के रूप में ads गिनें',
      'cashOut': 'निकासी',
      'reachViews': '{views} ads तक पहुँचें',
      'dailyChallenge': 'दैनिक चुनौती',
      'watchTodayVideosBonus': 'आज {videos} ads पूरे करें और अधिक ads गिनें!',
      ...
      'minimumPayoutIs': 'न्यूनतम भुगतान {views} ads है।',
      'processingCanTake':
      ...
      'minimumViewsHelper': 'न्यूनतम 1,000 ads',
      ...
      'termsViewsTitle': 'Ads और रिवॉर्ड',
      ...
      'termsUsingBullet2': 'अतिरिक्त ads बनाने के लिए एक व्यक्ति कई खातों, bots, scripts, VPN rotation या emulator farms का दुरुपयोग नहीं कर सकता।',
      'termsUsingBullet3':
          'रिवॉर्डेड विज्ञापन, Firebase प्रमाणीकरण और भुगतान समीक्षा वर्तमान प्लेटफ़ॉर्म सेटअप द्वारा सुरक्षित हैं।',
      'termsViewsBullet1': 'ऐप में गिने जाने वाले ads, VideoMoney के भीतर उपयोग होने वाली promotional reward units हैं।',
      'termsViewsBullet2':
      ...
      'termsPayoutsBullet1': 'न्यूनतम भुगतान 1,000 ads ही रहेगा।',
      'termsPayoutsBullet2':
    ...
    'de': {
      ...
      'signInBody': 'Melde dich an, um weiter Ads zu zählen und Auszahlungen zu verwalten.',
      'signUpBody':
      ...
      'wallet': 'Wallet',
      'profile': 'Profil',
      'rewardConfirmedViewsAdded': 'Belohnung bestätigt. Ad gezählt.',
      'rewardConfirmedViewsAddedCount': '+{count} Ads gezählt.',
      'bonusViewsAdded': '🎁 +{count} Ads gezählt',
      ...
      'watchVideosEarnPaid': 'Sieh dir Ads an, zähle Ads und lass dir auszahlen.',
      'currentViews': 'Aktuelle Ads',
      'videosWatched': 'Angesehene Videos',
      'progressToPayout': 'Fortschritt zur Auszahlung',
      'youAreOnYourWay': 'Du bist auf dem richtigen Weg.',
      'earnViewsNow': 'Verdiene jetzt Ads.',
      'payoutUnlocked':
          'Auszahlung freigeschaltet. Du kannst jetzt im Wallet eine Auszahlung anfordern.',
      'moreViewsUntilPayout': 'Noch {views} Ads bis zur Auszahlung.',
      'dailyBonus':
          'Täglicher Bonus',
      'watchDailyVideosBonus': 'Schließe täglich {videos} Ads ab, um mehr Ads zu zählen.',
      'bonusClaimed': 'Bonus erhalten',
      'bonus': 'Bonus',
      'earnViewsTitle': 'Ads verdienen',
      'watchRewardedEarnViews': 'Sieh dir Rewarded Ads an und zähle sofort Ads.',
      'earnViews': 'Ads verdienen',
      'howItWorks': 'So funktioniert es',
      'watch': 'Ansehen',
      'watchShortVideo': 'Ein kurzes Video ansehen',
      'earnStep': 'Verdienen',
      'getViewsReward': 'Gezählte Ads als Belohnung erhalten',
      'cashOut': 'Auszahlen',
      'reachViews': '{views} Ads erreichen',
      'dailyChallenge': 'Tägliche Herausforderung',
      'watchTodayVideosBonus': 'Schließe heute {videos} Ads ab und zähle mehr Ads!',
      ...
      'minimumPayoutIs': 'Die Mindestauszahlung beträgt {views} Ads.',
      'processingCanTake':
      ...
      'submitUsingBalance': 'Sende eine Auszahlung mit deinem Ad-Guthaben an.',
      'estimatedEarningsNotGuaranteed': 'Nur eine Schätzung. 1 Ad ≈ €0,001 und die tatsächlichen Einnahmen können variieren.',
      'payoutCurrency': 'Auszahlungswährung',
      'payoutMethod': 'Auszahlungsmethode',
      'viewsToRequest': 'Anzufordernde Ads',
      'minimumViewsHelper': 'Mindestens 1.000 Ads',
      ...
      'termsViewsTitle': 'Ads und Belohnungen',
      ...
      'termsUsingBullet2': 'Eine Person darf keine mehreren Konten, Bots, Skripte, VPN-Rotation oder Emulator-Farmen missbrauchen, um zusätzliche Ads zu erzeugen.',
      'termsUsingBullet3':
          'Rewarded Ads, Firebase-Authentifizierung und Auszahlungsprüfung bleiben durch die bestehende Plattform geschützt.',
      'termsViewsBullet1': 'Die in der App gezählten Ads sind Werbe-Belohnungseinheiten innerhalb von VideoMoney.',
      'termsViewsBullet2':
      ...
      'termsPayoutsBullet1':
          'Die Mindestauszahlung bleibt bei 1.000 Ads.',
      'termsPayoutsBullet2':
    ...
    'es': {
      ...
      'signInBody': 'Inicia sesión para seguir contando ads y gestionar pagos.',
      ...
      'wallet': 'Cartera',
      'profile': 'Perfil',
      'rewardConfirmedViewsAdded': 'Recompensa confirmada. Ad contado.',
      'rewardConfirmedViewsAddedCount': '+{count} ads contados.',
      'bonusViewsAdded': '🎁 +{count} ads contados',
      ...
      'watchVideosEarnPaid': 'Mira ads, cuenta ads y recibe pagos.',
      'currentViews': 'Ads actuales',
      'videosWatched': 'Vídeos vistos',
      'progressToPayout': 'Progreso hacia el pago',
      'youAreOnYourWay': 'Vas por buen camino.',
      'earnViewsNow': 'Gana ads ahora.',
      'payoutUnlocked': 'Pago desbloqueado. Puedes solicitar un pago en la Cartera.',
      'moreViewsUntilPayout': 'Faltan {views} ads para el pago.',
      'dailyBonus': 'Bono diario',
      'watchDailyVideosBonus': 'Completa {videos} ads al día para contar más ads.',
      'bonusClaimed': 'Bono reclamado',
      'bonus': 'Bono',
      'earnViewsTitle': 'Gana ads',
      'watchRewardedEarnViews': 'Mira ads recompensados y cuenta ads al instante.',
      'earnViews': 'Gana ads',
      'howItWorks': 'Cómo funciona',
      'watch': 'Ver',
      'watchShortVideo': 'Ver un vídeo corto',
      'earnStep': 'Ganar',
      'getViewsReward': 'Recibe ads contados como recompensa',
      'cashOut': 'Retirar',
      'reachViews': 'Alcanza {views} ads',
      'dailyChallenge': 'Desafío diario',
      'watchTodayVideosBonus': 'Completa hoy {videos} ads y cuenta más ads.',
      ...
      'availableViews': 'Ads disponibles',
      'estimatedPayout': 'Pago estimado',
      'remainingToPayout': 'Restante para el pago',
      'viewsUnit': 'ads',
      'estimateOnly': 'Solo una estimación. 1 ad ≈ €0,001 y las ganancias reales pueden variar.',
      ...
      'minimumPayoutIs': 'El pago mínimo es de {views} ads.',
      ...
      'submitUsingBalance': 'Envía una solicitud de pago usando tu saldo de ads.',
      'estimatedEarningsNotGuaranteed': 'Solo una estimación. 1 ad ≈ €0,001 y las ganancias reales pueden variar.',
      'payoutCurrency': 'Moneda de pago',
      'payoutMethod': 'Método de pago',
      'viewsToRequest': 'Ads a solicitar',
      'minimumViewsHelper': 'Mínimo 1.000 ads',
      ...
      'termsViewsTitle': 'Ads y recompensas',
      ...
      'termsUsingBullet2': 'Una persona no puede abusar de múltiples cuentas, bots, scripts, rotación de VPN o granjas de emuladores para generar ads extra.',
      ...
      'termsViewsBullet1': 'Los ads contados en la app son unidades promocionales de recompensa usadas dentro de VideoMoney.',
      ...
      'termsPayoutsBullet1': 'El pago mínimo sigue siendo de 1.000 ads.',
    ...
    'fr': {
      ...
      'signInBody': 'Connectez-vous pour continuer à compter des ads et gérer vos paiements.',
      ...
      'wallet': 'Portefeuille',
      'profile': 'Profil',
      'rewardConfirmedViewsAdded': 'Récompense confirmée. Ad compté.',
      'rewardConfirmedViewsAddedCount': '+{count} ads comptés.',
      'bonusViewsAdded': '🎁 +{count} ads comptés',
      ...
      'watchVideosEarnPaid': 'Regardez des ads, comptez des ads et soyez payé.',
      'currentViews': 'Ads actuels',
      'videosWatched': 'Vidéos regardées',
      'progressToPayout': 'Progression vers le paiement',
      'youAreOnYourWay': 'Vous êtes en bonne voie.',
      'earnViewsNow': 'Gagnez des ads maintenant.',
      'payoutUnlocked': 'Paiement débloqué. Vous pouvez demander un paiement dans le Portefeuille.',
      'moreViewsUntilPayout': 'Encore {views} ads avant le paiement.',
      'dailyBonus': 'Bonus quotidien',
      'watchDailyVideosBonus': 'Terminez {videos} ads par jour pour compter plus d’ads.',
      'bonusClaimed': 'Bonus réclamé',
      'bonus': 'Bonus',
      'earnViewsTitle': 'Gagner des ads',
      'watchRewardedEarnViews': 'Regardez des ads récompensés et comptez des ads instantanément.',
      'earnViews': 'Gagner des ads',
      'howItWorks': 'Comment ça fonctionne',
      'watch': 'Regarder',
      'watchShortVideo': 'Regarder une courte vidéo',
      'earnStep': 'Gagner',
      'getViewsReward': 'Recevez des ads comptés en récompense',
      'cashOut': 'Retirer',
      'reachViews': 'Atteignez {views} ads',
      'dailyChallenge': 'Défi quotidien',
      'watchTodayVideosBonus': 'Terminez {videos} ads aujourd’hui et comptez plus d’ads.',
      ...
      'viewsUnit': 'ads',
      'estimateOnly': 'Estimation uniquement. 1 ad ≈ 0,001 € et les gains réels peuvent varier.',
      ...
      'minimumPayoutIs': 'Le paiement minimum est de {views} ads.',
      ...
      'termsViewsTitle': 'Ads et récompenses',
      ...
      'termsUsingBullet2': 'Une seule personne ne peut pas abuser de comptes multiples, de bots, de scripts, de rotation VPN ou de fermes d’émulateurs pour générer des ads supplémentaires.',
      ...
      'termsViewsBullet1': 'Les ads comptés dans l’application sont des unités promotionnelles de récompense utilisées dans VideoMoney.',
      ...
      'termsPayoutsBullet1': 'Le paiement minimum reste de 1 000 ads.',
    ...
    'ru': {
      ...
      'signInBody': 'Войдите, чтобы продолжать считать ads и управлять выплатами.',
      ...
      'wallet': 'Кошелёк',
      'profile': 'Профиль',
      'rewardConfirmedViewsAdded': 'Награда подтверждена. Ad засчитан.',
      'rewardConfirmedViewsAddedCount': '+{count} ads засчитано.',
      'bonusViewsAdded': '🎁 +{count} ads засчитано',
      ...
      'watchVideosEarnPaid': 'Смотрите ads, считайте ads и получайте выплаты.',
      'currentViews': 'Текущие ads',
      'videosWatched': 'Просмотрено видео',
      'progressToPayout': 'Прогресс до выплаты',
      'youAreOnYourWay': 'Вы на верном пути.',
      'earnViewsNow': 'Зарабатывайте ads сейчас.',
      'payoutUnlocked': 'Выплата разблокирована. Вы можете запросить выплату в Кошельке.',
      'moreViewsUntilPayout': 'До выплаты осталось {views} ads.',
      'dailyBonus': 'Ежедневный бонус',
      'watchDailyVideosBonus': 'Завершайте {videos} ads в день, чтобы засчитывать больше ads.',
      'bonusClaimed': 'Бонус получен',
      'bonus': 'Бонус',
      'earnViewsTitle': 'Зарабатывайте ads',
      'watchRewardedEarnViews': 'Смотрите rewarded ads и мгновенно засчитывайте ads.',
      'earnViews': 'Зарабатывайте ads',
      'howItWorks': 'Как это работает',
      'watch': 'Смотреть',
      'watchShortVideo': 'Посмотреть короткое видео',
      'earnStep': 'Заработать',
      'getViewsReward': 'Получайте засчитанные ads в награду',
      'cashOut': 'Вывести средства',
      'reachViews': 'Достигните {views} ads',
      'dailyChallenge': 'Ежедневное задание',
      'watchTodayVideosBonus': 'Завершите сегодня {videos} ads и засчитайте больше ads.',
      ...
      'availableViews': 'Доступные ads',
      'estimatedPayout': 'Оценочная выплата',
      'remainingToPayout': 'Осталось до выплаты',
      'viewsUnit': 'ads',
      'estimateOnly': 'Только оценка. 1 ad ≈ €0,001, и фактический доход может отличаться.',
      ...
      'minimumPayoutIs': 'Минимальная выплата — {views} ads.',
      ...
      'submitUsingBalance': 'Отправьте запрос на выплату, используя баланс ads.',
      'estimatedEarningsNotGuaranteed': 'Только оценка. 1 ad ≈ €0,001, и фактический доход может отличаться.',
      'payoutCurrency': 'Валюта выплаты',
      'payoutMethod': 'Способ выплаты',
      'viewsToRequest': 'Ads для запроса',
      'minimumViewsHelper': 'Минимум 1 000 ads',
      ...
      'termsUsingBullet2': 'Один человек не может злоупотреблять несколькими аккаунтами, ботами, скриптами, VPN-ротацией или фермами эмуляторов для создания дополнительных ads.',
      ...
      'termsViewsBullet1': 'Ads, засчитываемые в приложении, являются рекламными наградными единицами внутри VideoMoney.',
      ...
      'termsPayoutsBullet1': 'Минимальная выплата остаётся 1 000 ads.',
    ...
    'el': {
      ...
      'signInBody': 'Συνδεθείτε για να συνεχίσετε να μετράτε ads και να διαχειρίζεστε πληρωμές.',
      ...
      'wallet': 'Πορτοφόλι',
      'profile': 'Προφίλ',
      'rewardConfirmedViewsAdded': 'Η ανταμοιβή επιβεβαιώθηκε. Το ad μετρήθηκε.',
      'rewardConfirmedViewsAddedCount': '+{count} ads μετρήθηκαν.',
      'bonusViewsAdded': '🎁 +{count} ads μετρήθηκαν',
      ...
      'watchVideosEarnPaid': 'Δες ads, μέτρα ads και πληρώσου.',
      'currentViews': 'Τρέχοντα ads',
      'videosWatched': 'Βίντεο που παρακολουθήθηκαν',
      'progressToPayout': 'Πρόοδος προς την πληρωμή',
      'youAreOnYourWay': 'Είστε στον σωστό δρόμο.',
      'earnViewsNow': 'Κέρδισε ads τώρα.',
      'payoutUnlocked': 'Η πληρωμή ξεκλειδώθηκε. Μπορείτε να ζητήσετε πληρωμή στο Πορτοφόλι.',
      'moreViewsUntilPayout': 'Απομένουν {views} ads μέχρι την πληρωμή.',
      'dailyBonus': 'Ημερήσιο μπόνους',
      'watchDailyVideosBonus': 'Ολοκλήρωσε {videos} ads καθημερινά για να μετρήσεις περισσότερα ads.',
      'bonusClaimed': 'Το μπόνους ελήφθη',
      'bonus': 'Μπόνους',
      'earnViewsTitle': 'Κέρδισε ads',
      'watchRewardedEarnViews': 'Δες rewarded ads και μέτρα ads αμέσως.',
      'earnViews': 'Κέρδισε ads',
      'howItWorks': 'Πώς λειτουργεί',
      'watch': 'Παρακολούθηση',
      'watchShortVideo': 'Παρακολουθήστε ένα σύντομο βίντεο',
      'earnStep': 'Κέρδος',
      'getViewsReward': 'Λάβε μετρημένα ads ως ανταμοιβή',
      'cashOut': 'Εξαργύρωση',
      'reachViews': 'Φτάσε τα {views} ads',
      'dailyChallenge': 'Ημερήσια πρόκληση',
      'watchTodayVideosBonus': 'Ολοκλήρωσε σήμερα {videos} ads και μέτρα περισσότερα ads.',
      ...
      'availableViews': 'Διαθέσιμα ads',
      'estimatedPayout': 'Εκτιμώμενη πληρωμή',
      'remainingToPayout': 'Υπόλοιπο μέχρι την πληρωμή',
      'viewsUnit': 'ads',
      'estimateOnly': 'Μόνο εκτίμηση. 1 ad ≈ €0,001 και τα πραγματικά κέρδη μπορεί να διαφέρουν.',
      ...
      'minimumPayoutIs': 'Η ελάχιστη πληρωμή είναι {views} ads.',
      ...
      'submitUsingBalance': 'Υποβάλετε αίτημα πληρωμής χρησιμοποιώντας το υπόλοιπο ads σας.',
      'estimatedEarningsNotGuaranteed': 'Μόνο εκτίμηση. 1 ad ≈ €0,001 και τα πραγματικά κέρδη μπορεί να διαφέρουν.',
      'payoutCurrency': 'Νόμισμα πληρωμής',
      'payoutMethod': 'Μέθοδος πληρωμής',
      'viewsToRequest': 'Ads προς αίτηση',
      'minimumViewsHelper': 'Ελάχιστο 1.000 ads',
      ...
      'termsViewsTitle': 'Ads και ανταμοιβές',
      ...
      'termsUsingBullet2': 'Ένα άτομο δεν επιτρέπεται να καταχράται πολλαπλούς λογαριασμούς, bots, scripts, εναλλαγή VPN ή farms εξομοιωτών για να δημιουργεί επιπλέον ads.',
      ...
      'termsViewsBullet1': 'Τα ads που μετρώνται στην εφαρμογή είναι προωθητικές μονάδες ανταμοιβής μέσα στο VideoMoney.',
      ...
      'termsPayoutsBullet1': 'Η ελάχιστη πληρωμή παραμένει 1.000 ads.',
